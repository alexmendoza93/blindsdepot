...
export const products: Product[] = [
  ...
  },
  {
    ...
    advice: "Debido a su confección, esta cortina utiliza un 'factor de plisado' alto, lo que significa que requiere más tela (generalmente el doble o más del ancho de la ventana). Al recogerse, los pliegues ocupan más espacio lateral; asegúrate de tener suficiente espacio en los extremos.",
    features: [
      {
        title: "Diseño Tradicional",
        description: "Agrupación de pliegues (generalmente 2 o 3) cosidos en la base, formando un abanico superior.",
        icon: "layers"
      },
      {
        title: "Caída Voluminosa",
        description: "Aporta presencia y formalidad, vistiendo el espacio con mayor contundencia.",
        icon: "align-left"
      },
      {
        title: "Control Preciso",
        description: "Fácil de deslizar mediante bastón o cordel, manteniendo siempre los pliegues armados.",
    ...
    techSpecs: [
      {
        title: "Instalación",
        description: "Se montan comúnmente en rieles técnicos o decorativos utilizando ganchos metálicos especiales que aseguran la forma del pliegue."
      },
      {
        title: "Mantenimiento",
  ...
  },
  {
    ...
    advice: "Asegúrate de que la barra decorativa se instale lo suficientemente alta por encima de la ventana para evitar filtraciones de luz, ya que los ojales pueden dejar pasar pequeños haces luminosos en la parte superior.",
    features: [
      {
        title: "Aros Integrados",
        description: "Ojales metálicos o plásticos insertados directamente en la tela para un look limpio.",
        icon: "circle"
      },
      {
        title: "Deslizamiento Rápido",
        description: "El contacto directo del aro con la barra permite abrir y cerrar de forma muy suave.",
        icon: "move-right"
      },
      {
        title: "Ondas Profundas",
        description: "Genera caídas anchas y regulares, menos estructuradas que el pliegue francés pero muy estéticas.",
        icon: "activity"
      }
    ],
    techSpecs: [
      {
        ...
        description: "Requiere obligatoriamente un cortinero de tubo (barra). Los ojales vienen en diferentes diámetros (generalmente 40mm) para adaptarse a varios grosores de tubo."
      },
      {
        title: "Acabados de Ojal",
        description: "Disponibles en níquel, bronce, acero mate, negro y oro para combinar perfectamente con la barra seleccionada."
      }
    ],
    gallery: [],
  },
  // Persianas
  {
    ...
    advice: "Para áreas muy soleadas, elige telas tipo 'Screen' con bajo porcentaje de apertura para reducir el calor y el deslumbramiento sin perder la vista. Para dormitorios, una enrollable 'Black Out' es imprescindible.",
    features: [
      {
        title: "Tubo de Aluminio",
        description: "Sistema interno resistente que enrolla la tela de forma perfecta y equilibrada.",
        icon: "cylinder"
      },
      {
        title: "Cadena o Motor",
        description: "Opciones de accionamiento manual mediante cadena continua o motorización a control remoto.",
        icon: "settings"
      },
      {
        title: "Diseño Limpio",
        description: "Líneas rectas que no sobrecargan la decoración, ideal para arquitectura moderna.",
        icon: "square"
      }
    ],
    techSpecs: [
      {
        title: "Mecanismo",
        description: "Sistemas manuales con reductores de peso para persianas grandes, o motores de batería de litio / cableados."
      },
      {
        title: "Fascia (Opcional)",
        description: "Puede incluir una fascia o cassette superior de aluminio que oculta el rollo, mejorando la estética y bloqueando más luz."
      }
    ],
    gallery: [],
  },
  {
    ...
    advice: "Son ideales para áreas sociales como salas o comedores donde se busca diseño y control de luz parcial. No son recomendables para oscuridad total (para ello mejor usar Día y Noche o Black Out directo), ya que entre las franjas siempre filtra un poco de luz.",
    features: [
      {
        title: "Diseño Zebra",
        description: "Tejido doble que alterna bandas opacas y de malla transparente.",
        icon: "align-justify"
      },
      {
        title: "Alineación Precisa",
        description: "Permite traslapar las líneas para visión exterior o intercalarlas para privacidad.",
        icon: "sliders"
      },
      {
        title: "Cassette Integrado",
        description: "Incluyen de fábrica un cabezal estético de aluminio que cubre el mecanismo.",
        icon: "box"
      }
    ],
    techSpecs: [
      {
        ...
        description: "Las franjas varían entre 5cm y 10cm dependiendo de la colección y el impacto visual deseado."
      },
      {
        title: "Mantenimiento",
  ...
  },
  {
    ...
    advice: "Al instalarse dentro del marco de la ventana, asegúrate de tener al menos 10 cm de profundidad, ya que el soporte doble es más ancho que uno sencillo. Excelente inversión para recámaras principales y cuartos de TV.",
    features: [
      {
        title: "Soporte Doble",
        description: "Herraje especial diseñado para colocar dos tubos de forma compacta y segura.",
        icon: "layers"
      },
      {
        title: "Malla Screen (Día)",
        description: "Permite la vista exterior, corta el reflejo del sol y protege el interior.",
        icon: "sun"
      },
      {
        title: "Black Out (Noche)",
        description: "Bloquea al 100% el paso de la luz para un descanso profundo y reparador.",
        icon: "moon"
      }
    ],
    techSpecs: [
      {
        title: "Instalación",
        description: "Soportes dobles verticales u horizontales según el espacio disponible en la ventana."
      },
      {
        title: "Motorización",
        description: "Totalmente automatizable; se pueden integrar dos motores independientes controlados desde un mismo mando multicanal."
      }
    ],
    gallery: [],
  },
  {
    ...
    advice: "Aunque la tela sea 100% opaca, siempre hay una pequeña filtración de luz por los bordes laterales (halo de luz). Si deseas oscuridad total (100% real), recomendamos instalarla por fuera del marco (pasando 10cm por lado) y agregar una fascia superior.",
    features: [
      {
        title: "Recubrimiento Ahulado",
        description: "La parte trasera de la tela cuenta con capas poliméricas que bloquean los rayos UV.",
        icon: "shield"
      },
      {
        title: "Limpieza Sencilla",
        description: "Su superficie plastificada o tratada permite limpiarla con un paño húmedo fácilmente.",
        icon: "droplet"
      },
      {
        title: "Confort Térmico",
        description: "Reduce considerablemente el uso de aire acondicionado al bloquear el calor directo.",
        icon: "thermometer"
      }
    ],
    techSpecs: [
      {
        title: "Composición",
        description: "Típicamente 100% Poliéster o Fibra de Vidrio con recubrimiento de PVC / Acrílico."
      },
      {
        title: "Opciones de Color",
        description: "El frente es decorativo (variedad de colores), mientras que la parte posterior suele ser blanca o a tono para uniformidad desde la calle."
      }
    ],
    gallery: [],
  },
  {
    ...
    advice: "Cuidado con la privacidad nocturna: por la noche, cuando hay luz adentro y oscuridad afuera, el efecto se invierte y desde afuera se puede ver hacia el interior. En habitaciones, siempre acompáñala de un Black Out (sistema Día y Noche).",
    features: [
      {
        title: "Visibilidad Exterior",
        description: "Conexión con el exterior que evita la sensación de encierro.",
        icon: "eye"
      },
      {
        title: "Filtrado UV",
        description: "Múltiples opciones de apertura (1%, 3%, 5%, 10%) según la cantidad de sol directo.",
        icon: "sun"
      },
      {
        title: "Antibacteriano",
        description: "Tejidos técnicos ideales para cocinas o ambientes húmedos, no generan hongos.",
        icon: "shield-check"
      }
    ],
    techSpecs: [
      {
        ...
        description: "El 1% ofrece máxima privacidad térmica; el 5% es el balance perfecto; el 10% maximiza la vista y la entrada de luz."
      },
      {
        title: "Material",
  ...
  },
  {
    ...
    advice: "Son la mejor opción cuando se tiene un cancel con mucho tránsito hacia un patio o balcón. Opta por tabletas de tela rígida para un aspecto más cálido residencial, o tabletas de PVC para alto tráfico y limpieza rápida.",
    features: [
      {
        title: "Tabletas Independientes",
        description: "Láminas verticales de 90mm que cuelgan del riel superior de manera uniforme.",
        icon: "menu"
      },
      {
        title: "Giros de 180°",
        description: "Permiten dirigir la entrada del sol o cerrarse completamente empalmándose.",
        icon: "rotate-cw"
      },
      {
        title: "Aperturas Flexibles",
        description: "Pueden abrir hacia la derecha, hacia la izquierda, o dividirse al centro.",
        icon: "expand"
      }
    ],
    techSpecs: [
      {
        title: "Riel",
        description: "Riel de aluminio anodizado con carros autolubricados y cordón de desplazamiento de alta resistencia."
      },
      {
        title: "Material de Tabletas",
        description: "Disponibles en PVC (fácil lavado, lisas o texturizadas) o en tela (tratadas con apresto para mantener la rigidez)."
      }
    ],
    gallery: [],
  },
  {
    ...
    advice: "Es una de las persianas más delicadas debido a sus velos transparentes. No se recomienda en espacios con fuertes corrientes de aire con las ventanas abiertas, ni en lugares donde mascotas puedan rasgar la tela. Su limpieza debe ser siempre en seco o con plumero.",
    features: [
      {
        title: "Láminas Suspendidas",
        description: "Franjas de tela horizontales que giran como una persiana veneciana pero sin cordones visibles.",
        icon: "layers"
      },
      {
        title: "Difusión de Luz",
        description: "Los velos anterior y posterior suavizan los rayos solares, eliminando brillos molestos.",
        icon: "sun"
      },
      {
        title: "Alta Decoración",
        description: "Aporta un nivel de sofisticación inigualable por otros sistemas enrollables.",
        icon: "star"
      }
    ],
    techSpecs: [
      {
        title: "Mecanismo",
        description: "Mecanismo único que permite enrollar la persiana completa o detenerla y girar las láminas en posición baja."
      },
      {
        title: "Protección UV",
        description: "Con las láminas abiertas, bloquea hasta el 88% de los rayos UV; cerrada, hasta el 99%."
      }
    ],
    gallery: [],
  },
  // Toldos
  {
    ...
    advice: "Al ser fijos, asegúrate de que la inclinación y la altura inferior no estorben el paso ni la apertura de puertas. Son ideales para vestir comercios boutique, cafeterías o residencias con estilo neoclásico.",
    features: [
      {
        title: "Estructura Fija",
        description: "Marcos de aluminio o acero soldados a medida, recubiertos de tela tensada.",
        icon: "anchor"
      },
      {
        title: "Diseño 3D",
        description: "Ofrece volumen (forma de cúpula, cuña o curvatura) rompiendo paredes planas.",
        icon: "box"
      },
      {
        title: "Rotulación",
        description: "Las faldillas o el cuerpo central son perfectos para imprimir logos o textos.",
        icon: "pen-tool"
      }
    ],
    techSpecs: [
      {
        ...
        description: "Generalmente lonas acrílicas teñidas en masa (resistentes a la decoloración solar) o vinílicas (100% impermeables)."
      },
      {
        title: "Estructura",
  ...
  },
  {
    ...
    advice: "El toldo retráctil es excelente para sol y lluvia ligera, pero debes cerrarlo ante vientos fuertes o tormentas severas. Recomendamos altamente invertir en un 'Sensor de Viento' para que el toldo se guarde solo y evites daños si olvidas hacerlo.",
    features: [
      {
        title: "Brazos Articulados",
        description: "Brazos de aluminio con resortes de tensión y cables internos que empujan el toldo hacia afuera.",
        icon: "maximize"
      },
      {
        title: "Cofre Opcional",
        description: "Puedes elegir un sistema con 'Cofre' que encapsula y protege la lona y brazos 100% al cerrarse.",
        icon: "box"
      },
      {
        title: "Automatización",
        description: "Motorizado con control remoto y compatibilidad con sensores climáticos (sol/viento).",
        icon: "zap"
      }
    ],
    techSpecs: [
      {
        ...
        description: "Se pueden fabricar en anchos de hasta 6-7 metros y proyecciones de hasta 3.5 metros por módulo."
      },
      {
        title: "Telas",
  ...
  },
  {
    ...
    advice: "Es la solución ideal para el sol del atardecer (sol poniente) que entra casi horizontal, donde un toldo de techo no serviría. Asegúrate de instalar los seguros de piso para mantener la tensión de la lona cuando hay brisa.",
    features: [
      {
        title: "Diseño Vertical",
        description: "Cae por gravedad desde el tubo superior hasta el piso o barandal.",
        icon: "arrow-down"
      },
      {
        title: "Fijación Inferior",
        description: "Incluye ganchos o argollas en el contrapeso para anclaje firme al nivel deseado.",
        icon: "anchor"
      },
      {
        title: "Diversidad de Tejidos",
        description: "Puede ser lona acrílica, malla screen o vinilo transparente (para lluvias sin perder vista).",
        icon: "layers"
      }
    ],
    techSpecs: [
      {
        title: "Estructura",
        description: "Tubo de aluminio robusto sin cajón guía. Opcionalmente puede tener cables de acero laterales como guías sencillas."
      },
      {
        title: "Manejo",
  ...
  },
  {
    ...
    advice: "Ideal para ventanas de recámaras o cocinas que reciben mucho sol pero donde necesitas seguir abriendo la hoja de cristal. Su ángulo crea una cámara de aire que enfría la ventana muy eficientemente.",
    features: [
      {
        title: "Brazo Pivote",
        description: "El brazo se fija a la pared lateral a media altura de la ventana y empuja la lona hacia afuera.",
        icon: "maximize"
      },
      {
        title: "Ángulo Variable",
        description: "Puede bajarse totalmente plano (180°) o quedar en proyección (90° a 135°).",
        icon: "activity"
      },
      {
        title: "Economía de Espacio",
        description: "No requiere gran estructura, es ligero y estéticamente discreto al cerrarse.",
        icon: "minimize"
      }
    ],
    techSpecs: [
      {
        title: "Resistencia",
        description: "Gracias al punto de apoyo triangular, soporta vientos moderados mejor que un brazo articulado grande."
      },
      {
        title: "Tensión",
        description: "Mecanismo interno con resortes en los brazos que mantienen la lona permanentemente tensa."
      }
    ],
    gallery: [],
  },
  {
    ...
    advice: "Si buscas cerrar una terraza para usarla todo el año como comedor o sala exterior, el Toldo ZIP es la mejor inversión del mercado. En tela transparente (PVC) te aísla del clima severo; en tela Malla Screen, frena los vientos y el sol molestos.",
    features: [
      {
        title: "Sistema de Cremallera",
        description: "Los bordes de la lona tienen un cierre soldado que va asegurado dentro de los perfiles laterales.",
        icon: "lock"
      },
      {
        title: "Cajón Oculto",
        description: "Rollo contenido en un cofre de aluminio extruido muy elegante y compacto.",
        icon: "box"
      },
      {
        title: "Alta Ingeniería",
        description: "Sistemas mayormente motorizados por la tensión que manejan, asegurando suavidad de uso.",
        icon: "settings"
      }
    ],
    techSpecs: [
      {
        ...
        description: "Certificaciones clase 3 a 6 (dependiendo la dimensión), el más resistente en sistemas verticales."
      },
      {
        title: "Dimensiones Máximas",
        description: "Permite cubrir grandes claros (hasta 6m de ancho) sin divisiones ni soportes intermedios."
      }
    ],
    gallery: [],
  },
  {
    ...
    advice: "Muy recomendado para negocios de hostelería o puertas de arco medio. A diferencia de otros toldos curvos retráctiles, los domos en forma de esfera suelen ser fijos por su complejidad, lo cual garantiza una altísima durabilidad pero requiere permisos de fachada en algunos residenciales.",
    features: [
      {
        title: "Forma 3D",
        description: "Estructura semiesférica de varios aros que tensionan la tela de forma magistral.",
        icon: "globe"
      },
      {
        title: "Protección Envolvente",
        description: "Cubre por arriba y por los laterales, evitando filtraciones en los costados.",
        icon: "shield"
      },
      {
        title: "Estética Atractiva",
        description: "Su diseño voluminoso atrae miradas, ideal para resaltar negocios en la calle.",
        icon: "star"
      }
    ],
    techSpecs: [
      {
        title: "Fabricación",
        description: "Confección artesanal de la lona en gajos termosoldados para evitar filtraciones de agua en las costuras."
      },
      {
        title: "Perfiles",
        description: "Típicamente fabricado con aros de aluminio rolados a medida para no oxidarse con la humedad constante."
      }
    ],
    gallery: [],
  },
