  ...
  return (
    <section className="bg-surface-container-low py-40 px-12">
      <div className="mb-20 text-center">
        <span className="font-sans text-secondary tracking-[0.3em] uppercase text-[10px] mb-4 block">Selection</span>
        <h2 className="font-serif text-5xl text-white">Curated Collections</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-[1000px] md:h-[800px]">
        ...
        <div className="md:col-span-8 relative group overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-all duration-700 flex flex-col justify-end p-12">
            <h3 className="font-serif text-4xl text-white mb-2">Roller Blinds</h3>
            <p className="font-sans text-on-surface-variant text-xs tracking-widest uppercase">Pure Minimalism</p>
          </div>
        </div>
        ...
        <div className="md:col-span-4 relative group overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-all duration-700 flex flex-col justify-end p-12">
            <h3 className="font-serif text-4xl text-white mb-2">Venetian</h3>
            <p className="font-sans text-on-surface-variant text-xs tracking-widest uppercase">Structural Precision</p>
          </div>
        </div>
        ...
        <div className="md:col-span-12 relative group overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-all duration-700 flex flex-col justify-end p-12">
            <h3 className="font-serif text-4xl text-white mb-2">Plantation Shutters</h3>
            <p className="font-sans text-on-surface-variant text-xs tracking-widest uppercase">Classic Elegance</p>
          </div>
        </div>
      </div>
    </section>
