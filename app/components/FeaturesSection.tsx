export default function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Agende una cita personalizada. Mediremos sus espacios y le presentaremos opciones exclusivas en tejidos y colores. Descubra el lujo, a su medida.",
      icon: (
        <svg
          className="w-8 h-8 text-secondary"
          fill="none"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8 relative z-10">
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <p className="font-sans text-white/70 text-md leading-relaxed max-w-sm px-4">
                {feature.description}
              </p>
            </div>
          ))}
