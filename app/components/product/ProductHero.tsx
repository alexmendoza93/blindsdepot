export default function ProductHero({ title, adjectives, image }: { title: string, adjectives: string[], image: string }) {
  return (
    <section className="relative w-full h-[100vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/40 to-[#0e100f]" />
      </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center animate-bounce">
        <span className="text-white text-[10px] tracking-widest uppercase mb-2 opacity-60">Descubrir</span>
        <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-white opacity-60">
