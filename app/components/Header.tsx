  ...
  return (
    <header className="bg-[#131313]/60 backdrop-blur-xl docked full-width top-0 sticky z-50 flex justify-between items-center w-full px-12 py-6">
      ...
      <nav className="hidden md:flex items-center space-x-12">
        <a className="text-white border-b border-[#eabf8e] pb-1 font-sans tracking-[0.1em] uppercase text-xs transition-colors duration-500" href="#">Colecciones</a>
        <a className="text-gray-400 font-sans tracking-[0.1em] uppercase text-xs hover:text-[#eabf8e] transition-colors duration-500" href="#">Nosotros</a>
      </nav>
