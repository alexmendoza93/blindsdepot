    ...
    >
      <div className="order-2 md:order-1">
        ...
        <p className="font-sans text-on-surface-variant text-lg leading-relaxed mb-12 max-w-md">
          En Blinds Depot, vemos el cubrimiento de ventanas como la capa
          arquitectónica final. Cada pieza es meticulosamente elaborada para
          modular la atmósfera, proporcionando un control preciso sobre la
          privacidad y la suave difusión de la luz.
        </p>
      </div>
